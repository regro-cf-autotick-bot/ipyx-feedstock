...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12798&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyx` can be installed with:

```
conda install ipyx
```

It is possible to list all of the versions of `ipyx` available on your platform with:
